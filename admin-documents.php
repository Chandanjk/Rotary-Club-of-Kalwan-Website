      ...
      <div class="container">
        <div class="row center">
          <div class="col-lg-12 center">
            <a href="" class="text-white btn btn-danger margin-bottom" data-toggle="modal" data-target="#myModal">Add Documents</a>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row mb-5 ">
          <div class="col-md-7 text-center mx-auto">
            <h2 class="serif">Our Documents</h2>
          </div>
        </div>
                ...
                echo '<div class="col-lg-4 col-md-6 mb-4">
                        <div class="post-entry-1 h-100 post-entry-design">
                          ...
                          <form method="post" action="php/delete.php" style="z-index:2;position:relative;">
                            ...
                            <button type="submit" name="delete_documents" value="delete" class="btn btn-danger white make-inline" style="width:100%;border-radius:0px;">Delete</button>
                          </form>
                        </div>
                      </div>';
              }
            ...
            <div class="col-md-12">
              <div class="card">
                <article class="card-body">
                  <form method="post" action="php/documents_insert.php" enctype="multipart/form-data">
