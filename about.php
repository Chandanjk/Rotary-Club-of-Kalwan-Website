            ...
            <div id="carouselExampleSlidesOnly" class="carousel size-max" data-ride="carousel" style="z-index:0;">
              <div class="carousel-inner" style="border-radius: 20px;">
                <div class="carousel-item active size-max">
                  <img class="d-block w-100" src="images/about1.jpeg" alt="First slide">
                </div>
                <div class="carousel-item size-max">
                  <img class="d-block w-100" src="images/about2.jpeg" alt="Second slide">
                </div>
                <div class="carousel-item size-max">
                  <img class="d-block w-100" src="images/about3.jpeg" alt="Third slide">
                </div>
                <div class="carousel-item size-max">
                  <img class="d-block w-100" src="images/about4.jpeg" alt="Third slide">
                </div>
                <div class="carousel-item size-max">
                  <img class="d-block w-100" src="images/about5.jpeg" alt="Third slide">
                </div>
                <div class="carousel-item size-max">
                  <img class="d-block w-100" src="images/about6.jpeg" alt="Third slide">
                </div>
                <div class="carousel-item size-max">
                  <img class="d-block w-100" src="images/about7.jpeg" alt="Third slide">
                </div>
                <div class="carousel-item size-max">
                  <img class="d-block w-100" src="images/about8.jpeg" alt="Third slide">
                </div>
                <div class="carousel-item size-max">
                  <img class="d-block w-100" src="images/about9.jpeg" alt="Third slide">
                </div>
                <div class="carousel-item size-max">
                  <img class="d-block w-100" src="images/about10.jpeg" alt="Third slide">
                </div>
                <div class="carousel-item size-max">
                  <img class="d-block w-100" src="images/about11.jpeg" alt="Third slide">
                </div>
                <div class="carousel-item size-max">
                  <img class="d-block w-100" src="images/about12.jpeg" alt="Third slide">
                </div>
                <div class="carousel-item size-max">
                  <img class="d-block w-100" src="images/about13.jpeg" alt="Third slide">
                </div>
                <div class="carousel-item size-max">
                  <img class="d-block w-100" src="images/about14.jpeg" alt="Third slide">
                </div>
