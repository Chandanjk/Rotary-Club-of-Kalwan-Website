      ...
      <header class="site-navbar site-navbar-target" role="banner">
        <div class="container">
          <div class="row align-items-center position-relative">
            <div class="col-3 ">
              <div class="site-logo make-inline">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6">
            ...
            <p><a href="#works" class="btn btn-primary text-white px-5 left margin-bottom">Our works</a></p>
          </div>
          <div class="col-md-6">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-2 text-center more-btn">
            <a href="admin-work.php">see more...</a>
          </div>
        </div>
      </div>
    ...
    <div class="site-section bg-light">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-10"></div>
          <div class="col-md-2 text-center more-btn">
            <a href="admin-news.php">see more...</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-10"></div>
          <div class="col-md-2 text-center more-btn">
            <a href="admin-documents.php">see more...</a>
          </div>
        </div>
      </div>
    </div>-->
